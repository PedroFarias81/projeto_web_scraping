...
## Esse projeto faz parte do workshop de Web Scraping da Jornada de Dados

[Link para o projeto original](https://github.com/lvgalvao/IphoneProjectWebScraping/)
...
1. **Clone o Repositório**:
   ```bash
   git clone https://github.com/PedroFarias81/projeto_web_scraping.git
   cd projeto_web_scraping
   ```
...
2. **Executar o Contêiner com as Variáveis de Ambiente do `.env`**:
   ...
   - `--name app_container`: Nomeia o conteiner como `app_container`.
...
```bash
sudo git clone https://github.com/PedroFarias81/projeto_web_scraping.git
cd projeto_web_scraping
```
...
No diretório `/home/ubuntu/projeto_web_scraping`, crie o arquivo `.env` para armazenar as variáveis de ambiente necessárias:
